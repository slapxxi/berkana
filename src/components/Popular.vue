...
<template>
  <div class="col-[full] mt-20">
    <h2 class="text-center text-3xl font-bold">{{ title }}</h2>
  </div>

  <div class="col-[full] mt-10 mb-20 grid grid-cols-subgrid bg-neutral-100/70 pt-13 pb-30">
    <div class="col-[main] grid gap-x-8 md:grid-cols-3">
      <DetailsCard
        ...
        :price="item.price"
        class="md:row-span-5 md:grid-rows-subgrid"
      />
    </div>
  </div>
</template>
